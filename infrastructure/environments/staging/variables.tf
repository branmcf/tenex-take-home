...
variable "github_connection_arn" {
  description = "ARN of the existing GitHub connection for App Runner"
  type        = string
}
...
variable "backend_memory" {
  description = "Memory in MB for backend App Runner service"
  type        = string
  default     = "1024"
}
...
variable "marketing_certificate_arn" {
  description = "ARN of ACM certificate for marketing site HTTPS"
  type        = string
  default     = ""
}
...
variable "docs_domain" {
  description = "Custom domain for the documentation site (optional, e.g., docs.staging.example.com)"
  type        = string
  default     = ""
}
