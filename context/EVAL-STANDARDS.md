...
- **Repository:** Gauntlet-HQ/prod-evals-cookbook
- **Branch:** main
- **Total Files:** 63
- **Generated:** 2026-02-05T01:02:56.033Z
...
```
Gauntlet-HQ/prod-evals-cookbook/
├── setup_agent
│   ├── config.py
│   ├── demo.ipynb
│   ├── eval_checks.py
...
│   ├── golden_data.yaml
│   └── walkthrough.ipynb
├── stage_2_labeled_scenarios
│   ├── evaluator.py
│   ├── scenarios.yaml
│   └── walkthrough.ipynb
├── stage_3_replay_harnesses
│   ├── fixtures
│   │   ├── example_refund_policy.json
│   │   └── Whatsourrefundpo_20260113_221437.json
│   ├── evaluator.py
│   ├── metrics.py
│   ├── player.py
│   ├── recorder.py
...
# Local environment (will be set via docker-compose)
...
name = "ask-acme"
version = "0.1.0"
description = "Production Evals Cookbook - Learn AI evaluation through building Ask Acme"
authors = [{ name = "Ash Tilawat", email = "apply@gauntlethq.com" }]
readme = "README.md"
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "- Video: camera encouraged but not required; virtual backgrounds ok; mute when not speaking.\n",
      "Source: remote_work_policy.md (“Communication Expectations”)\n",
      "\n",
      "5) In-office days (SF office)\n",
      "- If you’re near the San Francisco office, in-office presence is encouraged (not required) on Tuesdays and Thursdays.\n",
      "- Office hours: Monday–Friday, 8 AM–6 PM.\n",
      "Source: remote_work_policy.md (“In-Office Days”)\n",
      "\n",
      "6) International remote work\n",
      "- You may work internationally for up to 4 weeks per calendar year with manager approval.\n",
      "- Longer arrangements require HR and Legal review (tax implications).\n",
      "Source: remote_work_policy.md (“International Remote Work”)\n",
      "\n",
      "Questions: people-ops@acme-corp.com\n",
      "Source: remote_work_policy.md (“Questions”)\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "- Refund transactions processed: 8\n",
      "- Total refunded amount: $6,230.00\n",
      "\n",
      "Source: Analytics DB table refunds (query: refunds processed_at between 2024-10-01 and 2025-01-01)\n"
     ]
    }
   ],
   "source": [
...
================================================================================
// File: setup_agent/eval_checks.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: setup_agent/orchestrator.py
================================================================================
"""
...
================================================================================
// File: setup_agent/vector_search.py
================================================================================
"""
...
================================================================================
// File: setup_environment/Dockerfile
================================================================================
...
================================================================================
// File: setup_environment/docker-compose.yml
================================================================================
version: "3.8"
...
services:
  ...
  # Python app container - alternative to local uv installation
  app:
    build:
      context: ..
      dockerfile: setup_environment/Dockerfile
    container_name: acme-app
    ports:
      - "8888:8888"
    volumes:
      # Mount project for live editing (notebooks, code changes)
      - ..:/app
...
================================================================================
// File: setup_environment/env.example
================================================================================
# OpenAI API Key (required for embeddings and LLM calls)
OPENAI_API_KEY=sk-your-key-here

# Database connections (defaults work with docker-compose.yml)
...
================================================================================
// File: setup_environment/verify_setup.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: setup_seed_data/mcp_fixtures/jira_tickets.json
================================================================================
{
  "projects": [
    {
      ...
      "name": "Platform",
      "lead": "Sarah Chen",
      "description": "Core platform, API, infrastructure"
    },
    {
      "key": "MOB",
      "name": "Mobile",
    ...
    },
    {
      ...
      "description": "Activation, onboarding, experimentation"
    }
  ],
  "tickets": [
    {
      ...
      "priority": "P0",
      "status": "Resolved",
      "summary": "Authentication service returning 500 errors intermittently",
      "description": "Starting around 2:30 PM PT, users are experiencing intermittent 500 errors when trying to log in. Error rate is approximately 5% of login attempts.\n\n**Impact**: ~200 users affected\n**Root Cause**: Redis connection pool exhaustion\n**Resolution**: Increased pool size from 50 to 200",
      "reporter": "Emily Watson",
      "assignee": "James Liu",
      "created": "2025-01-12T14:45:00Z",
      "updated": "2025-01-12T16:30:00Z",
      "resolved": "2025-01-12T15:55:00Z",
      "labels": ["auth", "production", "incident"],
    ...
    },
    {
      ...
      "description": "As discussed in the API review, we need to implement rate limiting to protect against abuse.\n\n**Acceptance Criteria**:\n- 1000 requests/min for authenticated users\n- 100 requests/min for unauthenticated\n- Return 429 with Retry-After header\n- Dashboard for monitoring rate limit hits",
    ...
    },
    {
      ...
      "status": "Open",
      "summary": "iOS app crashes when opening project with 500+ tasks",
      "description": "Users with large projects are experiencing crashes when trying to open the project view.\n\n**Reproduction**:\n1. Open project with 500+ tasks\n2. Scroll through task list\n3. App crashes after ~10 seconds\n\n**Device**: iPhone 12 and earlier\n**iOS Version**: 16.x and 17.x",
      "reporter": "Customer Success",
      "assignee": null,
      "created": "2025-01-10T11:30:00Z",
      "updated": "2025-01-10T11:30:00Z",
      "labels": ["crash", "performance", "ios"],
      "components": ["iOS App"]
    },
    {
      ...
      "priority": "P2",
      "status": "In Progress",
      "summary": "Implement offline mode for task viewing",
      "description": "Allow users to view their tasks when offline. Changes sync when connection restored.\n\n**Scope**:\n- Cache last 50 tasks per project\n- Show offline indicator\n- Queue changes for sync",
    ...
    },
    {
      ...
      "priority": "P2",
      "status": "Open",
      "summary": "Add auto-scaling for Redis connection pool",
      "description": "Follow-up from PLAT-1247 incident. Implement auto-scaling for Redis connections based on load.\n\n**Requirements**:\n- Scale up when utilization > 70%\n- Scale down when utilization < 30% for 10 min\n- Alert when near max capacity",
      "reporter": "James Liu",
      "assignee": "James Liu",
      "created": "2025-01-12T16:00:00Z",
      "updated": "2025-01-12T16:00:00Z",
      "labels": ["infrastructure", "redis", "follow-up"]
    },
    {
      "key": "GROW-234",
      "type": "Story",
      "priority": "P2",
      "status": "Done",
      "summary": "Improve onboarding flow completion rate",
      "description": "Current onboarding completion is 62%. Target: 75%.\n\n**Changes**:\n- Reduce steps from 7 to 4\n- Add skip option for optional steps\n- Show progress indicator\n- Send reminder email after 24h if incomplete",
      "reporter": "Marcus Williams",
      "assignee": "Michael Brown",
      "created": "2024-11-15T10:00:00Z",
      "updated": "2025-01-05T11:00:00Z",
      "resolved": "2025-01-05T11:00:00Z",
      "labels": ["onboarding", "activation"],
      "story_points": 5
    },
    {
      "key": "PLAT-1180",
      ...
      "description": "Webhook retries are happening too quickly, causing issues for customers with slow endpoints.\n\n**Expected**: 1s, 5s, 30s, 2min, 10min\n**Actual**: All retries within 10 seconds",
      "reporter": "David Kim",
      "assignee": null,
    ...
    },
    {
      ...
      "description": "Users on Android 14 report not receiving push notifications.\n\n**Affected**: ~15% of Android user base\n**Suspected cause**: New notification permission changes in Android 14",
      "reporter": "Customer Success",
      "assignee": "Alex Rivera",
      "created": "2025-01-08T09:00:00Z",
      "updated": "2025-01-11T14:00:00Z",
      "labels": ["android", "notifications", "bug"]
    }
  ],
  "sprints": [
    {
      ...
      "end_date": "2025-01-20",
      "goal": "Complete rate limiting and resolve auth stability issues",
      "status": "active"
    },
    {
      "id": 125,
      "name": "Mobile Sprint 18",
      "project": "MOB",
      "start_date": "2025-01-06",
      "end_date": "2025-01-20",
      "goal": "Offline mode and performance improvements",
      "status": "active"
    }
  ]
}
...
================================================================================
// File: setup_seed_data/mcp_fixtures/slack_messages.json
================================================================================
{
  "channels": [
    {"id": "C001", "name": "general", "purpose": "Company-wide announcements"},
    {"id": "C002", "name": "engineering", "purpose": "Engineering discussions"},
    {"id": "C003", "name": "product", "purpose": "Product updates and debates"},
    {"id": "C004", "name": "incidents", "purpose": "Production incident coordination"},
    {"id": "C005", "name": "customer-feedback", "purpose": "Voice of the customer"}
  ],
  "users": [
    {"id": "U001", "name": "Sarah Chen", "title": "VP Engineering"},
    {"id": "U002", "name": "Marcus Williams", "title": "CPO"},
    {"id": "U003", "name": "Jennifer Martinez", "title": "CRO"},
    {"id": "U004", "name": "David Kim", "title": "VP Customer Success"},
    {"id": "U005", "name": "James Liu", "title": "Staff Engineer"},
    {"id": "U006", "name": "Priya Patel", "title": "Senior Engineer"},
    {"id": "U007", "name": "Alex Rivera", "title": "Mobile Lead"},
    {"id": "U008", "name": "Emily Watson", "title": "Engineering Manager"},
    {"id": "U009", "name": "Michael Brown", "title": "Senior PM"},
    {"id": "U010", "name": "Lisa Park", "title": "Enterprise AE"}
  ],
  "messages": [
    {
      "channel": "incidents",
      "thread": [
        {
          "ts": "2025-01-12T14:47:23Z",
          "user": "Emily Watson",
          "text": "🚨 *SEV1 INCIDENT DECLARED* 🚨\n\nAuth service returning intermittent 500 errors. ~5% of login attempts failing.\n\n*Incident Commander*: @James Liu\n*Comms Lead*: @Emily Watson"
        },
        {
          "ts": "2025-01-12T14:52:00Z",
          "user": "James Liu",
          "text": "Initial investigation: Redis connection pool showing exhaustion. Current pool size is 50, seeing 200+ waiting connections."
        },
        {
          "ts": "2025-01-12T15:05:00Z",
          "user": "James Liu",
          "text": "Deployed hotfix to increase pool size to 200. Monitoring error rates."
        },
        {
          "ts": "2025-01-12T15:20:00Z",
          "user": "James Liu",
          "text": "Error rate down to 0.1%. Continuing to monitor."
        },
        {
          "ts": "2025-01-12T15:55:00Z",
          "user": "Emily Watson",
          "text": "✅ *INCIDENT RESOLVED*\n\n*Duration*: 1 hour 8 minutes\n*Root Cause*: Redis connection pool exhaustion\n*Resolution*: Increased pool size\n*Follow-up*: PLAT-1250 created for auto-scaling"
        }
      ]
    },
    {
      ...
      "thread": [
        {
          ...
          "text": "Team, we need to finalize the new pricing tiers before the board meeting. Current proposal:\n\n• *Starter*: $12/user/mo (was $10)\n• *Professional*: $20/user/mo (no change)\n• *Enterprise*: Custom (no change)\n\nThoughts?"
        },
        {
          "ts": "2025-01-10T10:15:00Z",
          "user": "Jennifer Martinez",
          "text": "From sales perspective, the increase on Starter is fine - most competitors are at $12-15 for similar features. Happy we're keeping Pro at $20."
        },
        {
          "ts": "2025-01-10T10:22:00Z",
          "user": "David Kim",
          "text": "CS is supportive. The Starter customers most price-sensitive are on annual anyway, so they get the 20% discount."
        },
        {
          "ts": "2025-01-10T10:45:00Z",
          "user": "Marcus Williams",
          "text": "Great, sounds like we have alignment. I'll update the pricing doc and we'll implement Feb 1 for new customers, existing customers grandfathered for 6 months."
        }
      ]
    },
    {
      ...
      "thread": [
        {
          ...
          "user": "Sarah Chen",
          "text": "We need to make a call on the notification service rewrite. Options:\n\n1. *Keep Postgres* - Add partitioning, 3 weeks\n2. *Migrate to Kafka* - Better scalability, 6 weeks\n\nEngineering leads, please weigh in by EOD Thursday."
        },
        {
          "ts": "2025-01-08T14:30:00Z",
          "user": "James Liu",
          "text": "Leaning toward Kafka. We're hitting Postgres limits at 10k notifications/min. With mobile push coming, we'll easily 10x that."
        },
        {
          "ts": "2025-01-08T15:00:00Z",
          "user": "Priya Patel",
          "text": "Agree with James. Kafka also gives us replay capability for debugging."
        },
        {
          "ts": "2025-01-08T16:00:00Z",
          "user": "Alex Rivera",
          "text": "From mobile side, we need the higher throughput. Kafka gets my vote."
        },
        {
          "ts": "2025-01-09T09:00:00Z",
          "user": "Sarah Chen",
          "text": "Consensus on Kafka. @James Liu will lead. Kicking off next sprint. Thanks everyone! 🎉"
        }
      ]
    },
    {
      ...
      "thread": [
        {
          "ts": "2025-01-11T09:30:00Z",
          "user": "Lisa Park",
          "text": "Just got off a call with Globex ($18.5k MRR). They're asking about SSO group sync - auto-provision users based on AD groups. Is this on the roadmap?"
        },
        {
          "ts": "2025-01-11T09:45:00Z",
          "user": "Michael Brown",
          "text": "It's in the Q2 roadmap! We've heard this from 5 other enterprise accounts. Target is April."
        },
        {
          "ts": "2025-01-11T10:00:00Z",
          "user": "David Kim",
          "text": "Can we get early access for Globex? They've been great beta partners."
        },
        {
          "ts": "2025-01-11T10:15:00Z",
          "user": "Michael Brown",
          "text": "Absolutely. I'll add them to the beta cohort. @Lisa Park can you set expectations for mid-March beta?"
        }
      ]
    },
    {
      ...
      "thread": [
        {
          "ts": "2025-01-09T11:00:00Z",
          "user": "David Kim",
          "text": "Heads up - three enterprise customers mentioned mobile app performance in their QBRs this week. Specifically the large project crash issue."
        },
        {
          "ts": "2025-01-09T11:15:00Z",
          "user": "Alex Rivera",
          "text": "We're aware - it's MOB-892. It's affecting projects with 500+ tasks on older iPhones. We're prioritizing it for this sprint."
        },
        {
          "ts": "2025-01-09T11:30:00Z",
          "user": "David Kim",
          "text": "Thanks Alex. Can I tell them to expect a fix in the next 2 weeks?"
        },
        {
          "ts": "2025-01-09T11:45:00Z",
          "user": "Alex Rivera",
          "text": "Yes, that's a safe timeline. We'll have a beta build ready by end of next week."
        }
      ]
    },
    {
      ...
      "thread": [
        {
          ...
          "user": "Marcus Williams",
          "text": "📢 *All Hands Reminder*\n\nThis Friday at 10am PT. We'll cover:\n• Q4 results\n• 2025 roadmap preview\n• New hire intros\n\nSee you there!"
        }
      ]
    }
  ]
...
================================================================================
// File: setup_seed_data/postgres/schema.sql
================================================================================
...
================================================================================
// File: setup_seed_data/postgres/seed_data.sql
================================================================================
...
================================================================================
// File: setup_seed_data/seed_all.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: stage_1_golden_sets/evaluator.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: stage_1_golden_sets/golden_data.yaml
================================================================================
...
================================================================================
// File: stage_1_golden_sets/walkthrough.ipynb
================================================================================
{
 "cells": [
  {
...
================================================================================
// File: stage_2_labeled_scenarios/evaluator.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: stage_2_labeled_scenarios/scenarios.yaml
================================================================================
...
================================================================================
// File: stage_2_labeled_scenarios/walkthrough.ipynb
================================================================================
{
 "cells": [
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "single_tool/vector_only             6        5        1        0       \n"
     ]
    }
   ],
   "source": [
...
================================================================================
// File: stage_3_replay_harnesses/evaluator.py
================================================================================
#!/usr/bin/env python3
"""
...
================================================================================
// File: stage_3_replay_harnesses/fixtures/Whatsourrefundpo_20260113_221437.json
================================================================================
{
  "session_id": "Whatsourrefundpo_20260113_221437",
  "query": "What's our refund policy?",
  "response": "Acme Corp Customer Refund Policy (effective Jan 1, 2024; last updated Oct 1, 2024)\n\nWhen refunds are available\n\n1) Full refunds\n- Cancel within 30 days of the initial subscription.\n- Service outage exceeds our SLA commitment (99.9% uptime).\n- Incorrect billing due to Acme error.\n\n2) Pro-rata refunds\n- Cancel an annual subscription mid-term after the 30-day window.\n- Downgrade from a higher tier mid-billing cycle.\n\n3) No refunds\n- Monthly subscriptions: you can cancel anytime, but no refunds for partial months.\n- Usage-based charges already consumed.\n- Add-ons (e.g., storage, API calls) already used.\n\nHow customers request a refund\n- Contact support@acme-corp.com or use in-app chat.\n- Provide account email + reason.\n- We respond within 2 business days.\n- If approved, refunds are processed in 5\u20137 business days.\n\nApproval thresholds (internal)\n- Under $500: CS Representative\n- $500\u2013$5,000: CS Manager\n- $5,000\u2013$25,000: VP Customer Success\n- Over $25,000: CFO\n\nException\n- Enterprise customers on custom contracts should follow their specific agreement/MSA terms.\n\nSource: refund_policy.md (\u201cCustomer Refund Policy\u201d)",
  "tool_calls": [
    {
      "tool_name": "vector_search",
      "arguments": {
        "query": "refund policy Acme Corp"
      },
      "result": ""
    }
  ],
  ...
  "source_contents": [],
  "timestamp": "2026-01-13T22:14:45.620782",
  "annotations": {}
}

================================================================================
// File: stage_3_replay_harnesses/fixtures/example_refund_policy.json
================================================================================
{
  "session_id": "example_refund_policy",
  "query": "What is our refund policy and how many refunds did we process in Q4 2024?",
  "response": "Based on our refund policy (refund_policy.md), customers are eligible for a full refund if they cancel within 30 days of their initial subscription. Pro-rata refunds are available for annual subscriptions cancelled mid-term.\n\nAccording to our database, we processed 8 refunds in Q4 2024, totaling approximately $6,230. The refunds were approved by various CS team members including CS Reps and CS Managers, depending on the amount.",
  "tool_calls": [
    {
      "tool_name": "vector_search",
    ...
    {
      "tool_name": "sql_query", 
      "arguments": {"question": "How many refunds were processed in Q4 2024?"},
      "result": ""
    }
  ],
  "retrieved_sources": ["refund_policy.md"],
  "source_contents": [
    "# Customer Refund Policy\n\nCustomers are eligible for a full refund if they cancel within 30 days of their initial subscription..."
  ],
  "timestamp": "2025-01-13T10:00:00",
  "annotations": {
    "relevant_sources": ["refund_policy.md"],
    "expected_tools": ["vector_search", "sql_query"],
    "expected_facts": ["30 days", "8 refunds", "Q4 2024", "pro-rata"]
  }
}

================================================================================
// File: stage_3_replay_harnesses/metrics.py
================================================================================
"""
...
================================================================================
// File: stage_3_replay_harnesses/player.py
================================================================================
"""
...
================================================================================
// File: stage_3_replay_harnesses/recorder.py
================================================================================
"""
...
================================================================================
// File: stage_3_replay_harnesses/walkthrough.ipynb
================================================================================
{
  "cells": [
    {
...
================================================================================
// File: stage_4_rubrics/evaluator.py
================================================================================
"""
...
================================================================================
// File: stage_4_rubrics/rubric_config.py
================================================================================
"""
...
================================================================================
// File: stage_4_rubrics/rubrics.yaml
================================================================================
...
================================================================================
// File: stage_4_rubrics/walkthrough.ipynb
================================================================================
{
  "cells": [
    {
...
================================================================================
// File: stage_5_experiments/prompts/v1.txt
================================================================================
...
================================================================================
// File: stage_5_experiments/prompts/v2.txt
================================================================================
...
================================================================================
// File: stage_5_experiments/reporter.py
================================================================================
"""
...
================================================================================
// File: stage_5_experiments/runner.py
================================================================================
"""
...
================================================================================
// File: stage_5_experiments/variants.yaml
================================================================================
...
================================================================================
// File: stage_5_experiments/walkthrough.ipynb
================================================================================
{
  "cells": [
    {
      ...
      "metadata": {},
      "source": [
        "# Stage 5: Experiments — Data-Driven Agent Optimization\n",
        "\n",
        "---\n",
        "\n",
        "## 🎯 What You'll Learn\n",
        ...
        "---\n",
        "\n",
        "## 🏗️ Where Experiments Fit: The Eval Maturity Model\n",
        "\n",
        "```\n",
        "┌─────────────────────────────────────────────────────────────────┐\n",
        "│                    EVAL FRAMEWORK MATURITY                      │\n",
        "├─────────────────────────────────────────────────────────────────┤\n",
        "│                                                                 │\n",
        "│  ★ Stage 5: EXPERIMENTS ★  ← Compare configurations (YOU ARE HERE)│\n",
        "│      ▲                                                          │\n",
        "│  Stage 4: Rubrics          ← Multi-dimensional scoring (done)  │\n",
        "│      ▲                                                          │\n",
        "│  Stage 3: Replay Harnesses ← Reproducibility (done)            │\n",
        "│      ▲                                                          │\n",
        "│  Stage 2: Labeled Scenarios← Coverage mapping (done)           │\n",
        "│      ▲                                                          │\n",
        "│  Stage 1: Golden Sets      ← Baseline correctness (done)       │\n",
        "│                                                                 │\n",
        "└─────────────────────────────────────────────────────────────────┘\n",
        "```\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {},
      "source": [
        "## 🔍 Behind the Scenes: How Experiments Work\n",
        "\n",
        ...
        "│  │     model: gpt-4o-mini                                       │     │\n",
        "│  │     temperature: 0.1                                         │     │\n",
        "│  │     system_prompt: v2     ← Change one thing                 │     │\n",
        "│  └─────────────────────────────────────────────────────────────┘     │\n",
        "│                            │                                          │\n",
        "│                            ▼                                          │\n",
        "│  STEP 2: RUN TEST SUITE FOR EACH VARIANT                             │\n",
        "│  ┌─────────────────────────────────────────────────────────────┐     │\n",
        "│  │ For each variant:                                            │     │\n",
        "│  │   1. Create agent with variant config                        │     │\n",
        "│  │   2. Run all golden set test cases                           │     │\n",
        "│  │   3. Collect: pass/fail, rubric scores, latency, tokens      │     │\n",
        ...
        "│  │  gpt4o_upgrade    93%     4.5/5    2.1s     $0.015  ← Best!  │     │\n",
        ...
        "│  STEP 4: DECIDE                                                      │\n",
        "│  ┌─────────────────────────────────────────────────────────────┐     │\n",
        "│  │  \"GPT-4o is 6% more accurate and 0.4 higher rubric score,   │     │\n",
        "│  │   but costs 5x more and is 75% slower.                       │     │\n",
        "│  │                                                              │     │\n",
        "│  │   Decision: Use GPT-4o for high-stakes queries,              │     │\n",
    ...
    },
    {
      ...
      "metadata": {},
      "source": [
        "## 💻 Hands-On: Exploring Variant Definitions\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "print(\"=\" * 60)\n",
        "\n",
        "print(\"\\n🔧 Defaults (applied to all variants unless overridden):\")\n",
    ...
    },
    {
      ...
      "metadata": {},
      "source": [
        "## 📝 Understanding Variant Parameters\n",
        "\n",
        ...
        "\n",
        "```yaml\n",
        "# ❌ Bad: Multiple changes - can't tell what helped\n",
        "experiment_v2:\n",
        "  model: gpt-4o        # Changed\n",
        "  temperature: 0.0     # Changed  \n",
        "  system_prompt: v2    # Changed\n",
        "\n",
        "# ✅ Good: Single change - clear attribution\n",
        "gpt4o_test:\n",
        "  model: gpt-4o        # Changed\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "**⚠️ Note:** This makes real API calls and costs money. Use `--limit` for testing."
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        ...
        "# print_comparison(results)\n",
        "\n",
        "print(\"💡 To run an experiment, uncomment the code above.\")\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "─────────────────────────────────────────────────\n",
        "baseline         87%     4.1/5    1.2s     $0.003\n",
        "gpt4o_upgrade    93%     4.5/5    2.1s     $0.015  ← Best quality\n",
        "new_prompt       91%     4.3/5    1.3s     $0.003  ← Best value\n",
        "```\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {},
      "source": [
        "## 📈 Viewing Past Experiment Results\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        "## 🎓 Key Takeaways\n",
        "\n",
        "1. **Data beats intuition** — Run experiments instead of guessing\n",
        "2. **One change at a time** — Isolate variables to understand impact\n",
        "3. **Same test set** — Compare apples to apples across variants\n",
        "4. **Track all metrics** — Quality, latency, and cost together\n",
        "5. **Document decisions** — Record why you chose a configuration\n",
        "\n",
        "---\n",
        "\n",
        ...
        "### What's Next?\n",
        "\n",
        "1. **Integrate into CI** — Run golden sets on every commit\n",
        "2. **Set up monitoring** — Track rubric scores over time\n",
        "3. **Build feedback loops** — Turn production issues into test cases\n",
        "4. **Iterate** — Use experiments to continuously improve\n",
        "\n",
        "Happy evaluating! 🚀"
      ]
    }
